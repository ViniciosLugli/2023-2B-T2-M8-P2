...
RUN . /opt/ros/${ROS_DISTRO}/setup.bash && \
	cd /home/ubuntu/${PROJECT_FOLDER} && colcon build --symlink-install
...
## Add linker from ${PROJECT_FOLDER}/install/local_setup.bash to bashrc
RUN echo "source /home/ubuntu/${PROJECT_FOLDER}/install/local_setup.bash" >> /home/ubuntu/.bashrc